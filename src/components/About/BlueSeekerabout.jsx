      ...
      <div className="flex-1 p-4 mt-16 grid grid-cols-3 gap-4">
        ...
        <div className="sticky top-16 bg-white p-6 rounded-xl shadow-md col-span-1">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 mb-6">Seeking opportunities in various industries for blue-collar positions.</p>
            <button 
        ...
        <div className="col-span-2 bg-white p-6 rounded-lg shadow-md space-y-4">
          <h1 className="text-4xl font-bold text-gray-900 mb-6">About the Blue Seeker Module</h1>
          <p className="text-gray-700 mb-6">
            The Blue Seeker module is part of the <strong>Profile2Career</strong> project, designed to help blue-collar job seekers connect with employers looking for their skills and expertise.
          </p>
          ...
          <p className="text-gray-700 mb-6">
            ...
            <ul className="list-disc list-inside ml-4">
              ...
              <li>Connect with employers looking for skilled blue-collar workers</li>
          ...
          <ul className="list-disc list-inside ml-4 text-gray-700 mb-6">
            <li>Search for jobs based on skills and location</li>
            <li>Apply for multiple job opportunities with ease</li>
            <li>Receive real-time notifications for job updates</li>
            <li>Communicate directly with employers through the platform</li>
          </ul>

          <h2 className="text-2xl font-semibold mb-2">Project Timeline</h2>
          <p className="text-gray-700">
            The Blue Seeker module aligns with the overall Profile2Career project timeline, covering stages such as job searching, application management, and employer communication. Additional features and enhancements will be added based on user feedback.
          </p>
