    ...
    const fetchUserData = async (user) => {
      try {
        if (user) {
          ...
          const userDocRef = doc(db, 'whiteseeker', user.uid);  // 'whiteseekers' collection for White Seekers
        ...
        <div className="sticky top-16 bg-gray-100 p-6 rounded-xl shadow-black shadow-lg col-span-1">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-600 mb-6">
              You are dedicated to finding white-collar job opportunities that match your skills and expertise.
            </p>
            <hr className="w-2/3 border-t border-gray-300 mb-6" />
            <p className="text-gray-600 mb-6">
              Explore jobs posted by white-collar employers and apply to opportunities that suit your profile.
            </p>
          </div>
        </div>
        ...
        <div className="col-span-2">
          <div className="bg-gray-100 p-6 rounded-lg shadow-md shadow-gray-600 mb-6">
            ...
            <p className="text-gray-700 mb-6">
              The White Seeker module is part of the <strong>Profile2Career</strong> project, designed to help white-collar job seekers (seekers) find job opportunities posted by employers in various industries.
            </p>
            ...
            <p className="text-gray-700 mb-6">
              ...
              <ul className="list-disc list-inside ml-4">
                <li>Help white-collar job seekers discover relevant job postings</li>
                <li>Connect seekers with employers looking for skilled professionals</li>
            ...
            <p className="text-gray-700">
              The White Seeker module follows the overall Profile2Career project timeline. It involves stages such as job search, application tracking, and further enhancements like communication tools and skill-based job recommendations.
            </p>
          </div>
